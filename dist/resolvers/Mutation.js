...
var _hasPassword = require('../utils/hasPassword');

var _hasPassword2 = _interopRequireDefault(_hasPassword);
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.next = 2;
                            return (0, _hasPassword2.default)(args.data.password);
                ...
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        ...
                        case 3:
                            ...
                            throw new Error('Commnent not found!!!');
